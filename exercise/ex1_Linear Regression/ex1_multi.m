...
alpha1 = 0.03
theta1 = zeros(3, 1);
[theta, J1] = gradientDescentMulti(X, y, theta1, alpha1, num_iters);
plot(1:numel(J1), J1, '-r', 'LineWidth', 2);

hold on; % keep previous plot visible
alpha2 = 0.1
theta2 = zeros(3, 1);
[theta, J2] = gradientDescentMulti(X, y, theta2, alpha2, num_iters);
...
plot(1:numel(J5), J5, '-r', 'LineWidth', 2);
